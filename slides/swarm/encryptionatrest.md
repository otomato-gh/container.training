...
that you [provisioned yourself](https://github.com/otomato-gh/container.training/tree/master/prepare-machine) or with [Play-With-Docker](http://play-with-docker.com/), you might have to use a different method to restart the Engine.
